...
class Config(object):
    BOT_NAME = os.environ.get("BOT_NAME", "tgytdlp_bot")
    BOT_NAME_FOR_USERS = os.environ.get("BOT_NAME_FOR_USERS", "tgytdlp_bot")
    ADMIN = [int(x.strip()) for x in os.environ.get("ADMIN", "0").split(",") if x.strip()]
    ADMIN_USERNAME = os.environ.get("ADMIN_USERNAME", "@")
    ADMIN_GROUP = [int(x.strip()) for x in os.environ.get("ADMIN_GROUP", "").split(",") if x.strip()]
    ALLOWED_GROUP = [int(x.strip()) for x in os.environ.get("ALLOWED_GROUP", "").split(",") if x.strip()]
    ...
    COOKIE_URL = os.environ.get("COOKIE_URL", "http://configuration-webserver/cookies/cookie.txt")
    YOUTUBE_COOKIE_URL = os.environ.get("YOUTUBE_COOKIE_URL", "http://configuration-webserver/cookies/youtube.txt")
    YOUTUBE_COOKIE_URL_1 = os.environ.get("YOUTUBE_COOKIE_URL_1", "http://configuration-webserver/cookies/youtube-1.txt")
    YOUTUBE_COOKIE_URL_2 = os.environ.get("YOUTUBE_COOKIE_URL_2", "http://configuration-webserver/cookies/youtube-2.txt")
    YOUTUBE_COOKIE_URL_3 = os.environ.get("YOUTUBE_COOKIE_URL_3", "http://configuration-webserver/cookies/youtube-3.txt")
    YOUTUBE_COOKIE_URL_4 = os.environ.get("YOUTUBE_COOKIE_URL_4", "http://configuration-webserver/cookies/youtube-4.txt")
    YOUTUBE_COOKIE_URL_5 = os.environ.get("YOUTUBE_COOKIE_URL_5", "http://configuration-webserver/cookies/youtube-5.txt")
    YOUTUBE_COOKIE_URL_6 = os.environ.get("YOUTUBE_COOKIE_URL_6", "http://configuration-webserver/cookies/youtube-6.txt")
    YOUTUBE_COOKIE_URL_7 = os.environ.get("YOUTUBE_COOKIE_URL_7", "http://configuration-webserver/cookies/youtube-7.txt")
    YOUTUBE_COOKIE_URL_8 = os.environ.get("YOUTUBE_COOKIE_URL_8", "http://configuration-webserver/cookies/youtube-8.txt")
    YOUTUBE_COOKIE_URL_9 = os.environ.get("YOUTUBE_COOKIE_URL_9", "http://configuration-webserver/cookies/youtube-9.txt")
    YOUTUBE_COOKIE_URL_10 = os.environ.get("YOUTUBE_COOKIE_URL_10", "http://configuration-webserver/cookies/youtube-10.txt")
    ...
    INSTAGRAM_COOKIE_URL = os.environ.get("INSTAGRAM_COOKIE_URL", "http://configuration-webserver/cookies/instagram.txt")
    TIKTOK_COOKIE_URL = os.environ.get("TIKTOK_COOKIE_URL", "http://configuration-webserver/cookies/tiktok.txt")
    FACEBOOK_COOKIE_URL = os.environ.get("FACEBOOK_COOKIE_URL", "http://configuration-webserver/cookies/facebook.txt")
    TWITTER_COOKIE_URL = os.environ.get("TWITTER_COOKIE_URL", "http://configuration-webserver/cookies/twitter.txt")
    VK_COOKIE_URL = os.environ.get("VK_COOKIE_URL", "http://configuration-webserver/cookies/vk.txt")
